...
#define kWBLoginDoneNotification @"weiboLoginDone"
...
- (void)engine:(WBEngine *)engine requestDidSucceedWithResult:(id)result withRequestType:(WBRequestType)type;
...
//- (id)initWithAppKey:(NSString *)theAppKey appSecret:(NSString *)theAppSecret ssoCallbackScheme:(NSString*)ssoScheme;
