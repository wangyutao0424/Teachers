...
- (void)handleResponseData:(NSData *)data 
{
	...
	{
    if ([delegate respondsToSelector:@selector(request:didFinishLoadingWithResult:requestType:)])
		{
            [delegate request:self didFinishLoadingWithResult:(result == nil ? data : result) requestType:self.requestType];
		}
	}
}
