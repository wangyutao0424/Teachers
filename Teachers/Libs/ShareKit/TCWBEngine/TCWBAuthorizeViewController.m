...
- (void)viewDidLoad{
    ...
    [self.navigationItem setTitle:@"腾讯微博"];
//    UIBarButtonItem *baritemCancel = [[UIBarButtonItem alloc] initWithTitle:@"取消" style:UIBarButtonItemStyleBordered target:self action:@selector(onButtonCancel)];
